	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMetamodelAccess().getAlternatives_2(), "rule__Metamodel__Alternatives_2");
					...
					put(grammarAccess.getMetamodelAccess().getGroup_2_1(), "rule__Metamodel__Group_2_1__0");
					put(grammarAccess.getMergerAccess().getGroup(), "rule__Merger__Group__0");
					...
					put(grammarAccess.getMetamodelAccess().getModelPackageAssignment_2_0(), "rule__Metamodel__ModelPackageAssignment_2_0");
					put(grammarAccess.getMetamodelAccess().getIsTextAssignment_2_1_0(), "rule__Metamodel__IsTextAssignment_2_1_0");
					put(grammarAccess.getMetamodelAccess().getExtensionAssignment_2_1_1(), "rule__Metamodel__ExtensionAssignment_2_1_1");
					put(grammarAccess.getMergerAccess().getMergerAssignment_1(), "rule__Merger__MergerAssignment_1");
					put(grammarAccess.getMergerAccess().getNameAssignment_2(), "rule__Merger__NameAssignment_2");
					put(grammarAccess.getMergerAccess().getSourceModelAssignment_3(), "rule__Merger__SourceModelAssignment_3");
					put(grammarAccess.getMergerAccess().getAspectModelAssignment_4(), "rule__Merger__AspectModelAssignment_4");
					put(grammarAccess.getMergerAccess().getTargetModelAssignment_5(), "rule__Merger__TargetModelAssignment_5");
					put(grammarAccess.getGeneratorAccess().getGeneratorAssignment_1(), "rule__Generator__GeneratorAssignment_1");
					put(grammarAccess.getGeneratorAccess().getNameAssignment_2(), "rule__Generator__NameAssignment_2");
					...
					put(grammarAccess.getGeneratorAccess().getWriteTraceModelAssignment_5_1(), "rule__Generator__WriteTraceModelAssignment_5_1");
					put(grammarAccess.getGeneratorAccess().getReadTraceModelsAssignment_6_1(), "rule__Generator__ReadTraceModelsAssignment_6_1");
					put(grammarAccess.getGeneratorAccess().getReadTraceModelsAssignment_6_2_1(), "rule__Generator__ReadTraceModelsAssignment_6_2_1");
					put(grammarAccess.getSourceModelNodeSelectorAccess().getTypeAssignment_0_1(), "rule__SourceModelNodeSelector__TypeAssignment_0_1");
					put(grammarAccess.getTargetModelNodeTypeAccess().getNodeTypeAssignment_0(), "rule__TargetModelNodeType__NodeTypeAssignment_0");
					put(grammarAccess.getTargetModelNodeTypeAccess().getMultiplyAssignment_1(), "rule__TargetModelNodeType__MultiplyAssignment_1");
