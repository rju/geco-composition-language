		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getConectionsAssignment_4_0(), "rule__Model__ConectionsAssignment_4_0");
					put(grammarAccess.getModelAccess().getMetamodelsAssignment_4_1(), "rule__Model__MetamodelsAssignment_4_1");
