		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSourceMetamodelAccess().getAlternatives(), "rule__SourceMetamodel__Alternatives");
					put(grammarAccess.getTargetMetamodelAccess().getAlternatives(), "rule__TargetMetamodel__Alternatives");
					put(grammarAccess.getTargetAccess().getAlternatives_3(), "rule__Target__Alternatives_3");
					...
					put(grammarAccess.getModelMultiplicityAccess().getAlternatives(), "rule__ModelMultiplicity__Alternatives");
					put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
					put(grammarAccess.getIntermediateAccess().getGroup(), "rule__Intermediate__Group__0");
					...
					put(grammarAccess.getTargetAccess().getGroup_3_1(), "rule__Target__Group_3_1__0");
					...
					put(grammarAccess.getConnectionAccess().getGroup_6(), "rule__Connection__Group_6__0");
					put(grammarAccess.getConnectionAccess().getGroup_6_2(), "rule__Connection__Group_6_2__0");
					...
					put(grammarAccess.getModelAccess().getImportSectionAssignment_2(), "rule__Model__ImportSectionAssignment_2");
					put(grammarAccess.getModelAccess().getMetamodelsAssignment_3(), "rule__Model__MetamodelsAssignment_3");
					put(grammarAccess.getModelAccess().getConnectionsAssignment_4(), "rule__Model__ConnectionsAssignment_4");
					put(grammarAccess.getIntermediateAccess().getNameAssignment_1(), "rule__Intermediate__NameAssignment_1");
					put(grammarAccess.getIntermediateAccess().getSourceInstanceMultiplicityAssignment_3(), "rule__Intermediate__SourceInstanceMultiplicityAssignment_3");
					put(grammarAccess.getIntermediateAccess().getTargetInstanceMultiplicityAssignment_5(), "rule__Intermediate__TargetInstanceMultiplicityAssignment_5");
					put(grammarAccess.getIntermediateAccess().getLocationAssignment_6(), "rule__Intermediate__LocationAssignment_6");
					put(grammarAccess.getSourceAccess().getNameAssignment_1(), "rule__Source__NameAssignment_1");
					put(grammarAccess.getSourceAccess().getSourceInstanceMultiplicityAssignment_2(), "rule__Source__SourceInstanceMultiplicityAssignment_2");
					put(grammarAccess.getSourceAccess().getLocationAssignment_3(), "rule__Source__LocationAssignment_3");
					put(grammarAccess.getTargetAccess().getNameAssignment_1(), "rule__Target__NameAssignment_1");
					put(grammarAccess.getTargetAccess().getTargetInstanceMultiplicityAssignment_2(), "rule__Target__TargetInstanceMultiplicityAssignment_2");
					put(grammarAccess.getTargetAccess().getLocationAssignment_3_0(), "rule__Target__LocationAssignment_3_0");
					put(grammarAccess.getTargetAccess().getIsTextAssignment_3_1_0(), "rule__Target__IsTextAssignment_3_1_0");
					put(grammarAccess.getTargetAccess().getExtensionAssignment_3_1_1(), "rule__Target__ExtensionAssignment_3_1_1");
					put(grammarAccess.getMetamodelLocationAccess().getUrlAssignment(), "rule__MetamodelLocation__UrlAssignment");
					put(grammarAccess.getConnectionAccess().getGeneratorAssignment_1(), "rule__Connection__GeneratorAssignment_1");
					put(grammarAccess.getConnectionAccess().getSourceAssignment_2(), "rule__Connection__SourceAssignment_2");
					put(grammarAccess.getConnectionAccess().getTargetAssignment_4(), "rule__Connection__TargetAssignment_4");
					put(grammarAccess.getConnectionAccess().getWriteTraceModelAssignment_5_1(), "rule__Connection__WriteTraceModelAssignment_5_1");
					put(grammarAccess.getConnectionAccess().getReadTraceModelsAssignment_6_1(), "rule__Connection__ReadTraceModelsAssignment_6_1");
					put(grammarAccess.getConnectionAccess().getReadTraceModelsAssignment_6_2_1(), "rule__Connection__ReadTraceModelsAssignment_6_2_1");
