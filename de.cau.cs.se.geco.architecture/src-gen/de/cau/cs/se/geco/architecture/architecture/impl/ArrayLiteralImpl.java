 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.geco.architecture.architecture.impl.ArrayLiteralImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayLiteralImpl extends LiteralImpl implements ArrayLiteral
{
  ...
  {
    return ArchitecturePackage.Literals.ARRAY_LITERAL;
  }
  ...
  public EList<Literal> getLiterals()
  {
    if (literals == null)
    {
      literals = new EObjectContainmentEList<Literal>(Literal.class, this, ArchitecturePackage.ARRAY_LITERAL__LITERALS);
    }
    return literals;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArchitecturePackage.ARRAY_LITERAL__LITERALS:
