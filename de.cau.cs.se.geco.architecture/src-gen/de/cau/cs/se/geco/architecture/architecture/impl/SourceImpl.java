 ...
 * <ul>
 *   <li>{@link de.cau.cs.se.geco.architecture.architecture.impl.SourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.se.geco.architecture.architecture.impl.SourceImpl#getSourceInstanceMultiplicity <em>Source Instance Multiplicity</em>}</li>
 *   <li>{@link de.cau.cs.se.geco.architecture.architecture.impl.SourceImpl#getLocation <em>Location</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SourceImpl extends MetamodelImpl implements Source
{
  /**
  ...
  {
    return ArchitecturePackage.Literals.SOURCE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SOURCE__NAME, oldName, name));
  }
  ...
  public void setSourceInstanceMultiplicity(ModelMultiplicity newSourceInstanceMultiplicity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SOURCE__SOURCE_INSTANCE_MULTIPLICITY, oldSourceInstanceMultiplicity, sourceInstanceMultiplicity));
  }
  ...
  public NotificationChain basicSetLocation(MetamodelLocation newLocation, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SOURCE__LOCATION, oldLocation, newLocation);
  ...
  public void setLocation(MetamodelLocation newLocation)
  {
    if (newLocation != location)
    {
      ...
      if (location != null)
        msgs = ((InternalEObject)location).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArchitecturePackage.SOURCE__LOCATION, null, msgs);
      if (newLocation != null)
        msgs = ((InternalEObject)newLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArchitecturePackage.SOURCE__LOCATION, null, msgs);
      msgs = basicSetLocation(newLocation, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.SOURCE__LOCATION, newLocation, newLocation));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArchitecturePackage.SOURCE__LOCATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ArchitecturePackage.SOURCE__NAME:
        return getName();
      case ArchitecturePackage.SOURCE__SOURCE_INSTANCE_MULTIPLICITY:
