 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.se.geco.architecture.architecture.impl.TargetModelImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetModelImpl extends CombinedModelImpl implements TargetModel
{
    ...
    if (reference != null && reference.eIsProxy())
    {
      ...
      if (reference != oldReference)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ArchitecturePackage.TARGET_MODEL__REFERENCE, oldReference, reference));
      }
    }
    return reference;
  }
  ...
  public void setReference(Model newReference)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.TARGET_MODEL__REFERENCE, oldReference, reference));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ArchitecturePackage.TARGET_MODEL__REFERENCE:
