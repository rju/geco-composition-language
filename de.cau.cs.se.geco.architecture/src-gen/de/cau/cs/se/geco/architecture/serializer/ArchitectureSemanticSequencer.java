...
public class ArchitectureSemanticSequencer extends XbaseSemanticSequencer {
	...
	protected void sequence_Metamodel(EObject context, Metamodel semanticObject) {
		...
		feeder.accept(grammarAccess.getMetamodelAccess().getNameValidIDParserRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (target=[RegisteredPackage|ValidID] type=[EClass|ValidID] property=NodeProperty?)
	 */
	...
	/**
	 * Constraint:
	 *     (property=[EReference|ValidID] constraint=ConstraintExpression? subProperty=NodeProperty?)
	 */
	...
	/**
	 * Constraint:
	 *     (weaver=JvmTypeReference sourceModel=SourceModelNodeSelector aspectModel=AspectModel targetModel=TargetModelNodeType?)
	 */
