...
public class ArchitectureSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ArchitecturePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ArchitecturePackage.GENERATOR_IMPORT:
				if(context == grammarAccess.getGeneratorImportRule() ||
				   context == grammarAccess.getImportRule()) {
					sequence_GeneratorImport(context, (GeneratorImport) semanticObject); 
					return; 
				}
				else break;
			...
			case ArchitecturePackage.WEAVER_IMPORT:
				if(context == grammarAccess.getImportRule() ||
				   context == grammarAccess.getWeaverImportRule()) {
					sequence_WeaverImport(context, (WeaverImport) semanticObject); 
					return; 
				}
				else break;
			}
	...
	protected void sequence_GeneratorImport(EObject context, GeneratorImport semanticObject) {
		...
		feeder.accept(grammarAccess.getGeneratorImportAccess().getImportedNamespaceQualifiedNameParserRuleCall_1_0(), semanticObject.getImportedNamespace());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (type=JvmTypeReference metamodels+=Metamodel metamodels+=Metamodel*)
	 */
	...
	/**
	 * Constraint:
	 *     (name=QualifiedName imports+=Import* registeredPackages=XImportSection (connections+=Connection | metamodels+=MetamodelSequence)*)
	 */
	...
	/**
	 * Constraint:
	 *     (sourceNodes+=JvmTypeReference sourceNodes+=JvmTypeReference* targetNodes+=JvmTypeReference targetNodes+=JvmTypeReference*)
	 */
	...
	protected void sequence_WeaverImport(EObject context, WeaverImport semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getWeaverImportAccess().getImportedNamespaceQualifiedNameParserRuleCall_1_0(), semanticObject.getImportedNamespace());
		feeder.finish();
	}
