...
public abstract class AbstractArchitectureRuntimeModule extends DefaultRuntimeModule {
	...
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("core");
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return de.cau.cs.se.geco.architecture.jvmmodel.ArchitectureJvmModelInferrer.class;
	}
